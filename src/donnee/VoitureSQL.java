...
public interface VoitureSQL {
	...
	String SQL_MODIFIER_VOITURE = "UPDATE voiture SET modele = ?, couleur = ?, puissance = ?, annee = ? WHERE id_voiture = ?";
	String SQL_RAPPORTER_VOITURE = "SELECT * FROM voiture WHERE id_voiture = ?";
